...
const DEFAULT_CLIENT_VERSION = "1.12.1.6_20260609";
...
const DEVICE_PRESETS: DevicePreset[] = [
  ...
  },
  {
    ...
    deviceInfo: {
      ...
      deviceId: "iPhone15,2",
      userAgent:
        "Mozilla/5.0 (iPhone; CPU iPhone OS 17_4_1 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148 MicroMessenger/8.0.47(0x18002f2c) NetType/WIFI Language/zh_CN",
    },
  },
  {
    id: "iphone_16_pro",
    ...
    deviceInfo: {
      ...
      deviceId: "iPhone17,1",
      userAgent:
        "Mozilla/5.0 (iPhone; CPU iPhone OS 18_2_1 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/22C161 MicroMessenger/8.0.54(0x1800362c) NetType/WIFI Language/zh_CN",
    },
  },
  {
    id: "android_xiaomi",
    ...
    deviceInfo: {
      ...
      deviceId: "Xiaomi 14",
      userAgent:
        "Mozilla/5.0 (Linux; Android 14; 23127PN0CC Build/UKQ1.231003.002) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/116.0.0.0 Mobile Safari/537.36 XWEB/1165009 MMWEBSDK/20240407 MiniProgramEnv/android MicroMessenger/8.0.49.2680(0x28003137) NetType/WIFI Language/zh_CN ABI/arm64",
    },
  },
  {
    id: "android_huawei",
    ...
    deviceInfo: {
      ...
      userAgent:
        "Mozilla/5.0 (Linux; Android 14; ALN-AL10 Build/HUAWEIALN-AL10) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/116.0.0.0 Mobile Safari/537.36 XWEB/1165009 MMWEBSDK/20240407 MiniProgramEnv/android MicroMessenger/8.0.49.2680(0x28003137) NetType/WIFI Language/zh_CN ABI/arm64",
    },
  },
  {
    id: "ipad_pro",
    ...
    deviceInfo: {
      ...
      deviceId: "iPad14,6",
      userAgent:
        "Mozilla/5.0 (iPad; CPU OS 17_4 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Mobile/15E148 MicroMessenger/8.0.47(0x18002f2c) NetType/WIFI Language/zh_CN",
    },
  },
];

const DEFAULT_DEVICE_INFO: DeviceInfo = {
  ...DEVICE_PRESETS[0].deviceInfo,
...
function normalizeDeviceInfo(input: any): DeviceInfo {
  ...
  return {
    ...
    clientVersion: String(
      src.clientVersion || CONFIG.clientVersion || DEFAULT_CLIENT_VERSION,
    ).trim(),
    sysSoftware: String(
      src.sysSoftware || DEFAULT_DEVICE_INFO.sysSoftware,
    ).trim(),
